...
( 
	...
	FILENAME = 'D:\Quan_tri_he_co_so_du_lieu\SmallWorks.mdf', 
	SIZE = 10MB, 
	FILEGROWTH = 20%, 
	MAXSIZE = 50MB
), 
...
(
	...
	FILENAME = 'D:\Quan_tri_he_co_so_du_lieu\SmallWorksData1.ndf', 
	SIZE = 10MB, 
	FILEGROWTH = 20%, 
	MAXSIZE = 50MB
), 
...
( 
	...
	FILENAME = 'D:\Quan_tri_he_co_so_du_lieu\SmallWorksData2.ndf', 
	SIZE = 10MB, 
	FILEGROWTH = 20%, 
	MAXSIZE = 50MB
)
...
( 
	NAME = 'SmallWorks_log', 
	FILENAME = 'D:\Quan_tri_he_co_so_du_lieu\SmallWorks_log.ldf', 
	SIZE = 10MB, 
	FILEGROWTH = 10%, 
	MAXSIZE = 20MB
);
...
INSERT dbo.Contact (ContactID, FirstName, LastName, EmailAddress, Phone)
SELECT ContactID, FirstName, LastName, EmailAddress, Phone
FROM AdventureWorks.Person.Contact
WHERE ContactID < 5000;

INSERT dbo.Product (ProductID, ProductName, ProductNumber, StandardCost, ListPrice)
